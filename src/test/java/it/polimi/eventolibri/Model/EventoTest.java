...
class EventoTest {
    ...
    @Test
    void evento() {
        // Creazione di un evento di esempio
        ...
        // Creazione di un secondo evento di esempio con ID specificato
        Evento evento2 = new Evento(1, creatore, "Evento di prova2", luogo, date, scaletta);
        // Verifica che gli eventi siano stati creati correttamente
    ...
    void setId() {
        ...
        // Imposta l'ID dell'evento e verifica che sia stato impostato correttamente
        evento.setId(5);
        assertEquals(5, evento.getId());
    }

    // Test per il metodo aggiornaEvento
    @Test
    void aggiornaEvento() {
        // Creazione di un evento di esempio
        ...
        // verifica listener creatore e lettori
        ...
        assertEquals(genitore1, evento1.getListeners().get(3)); // verifica listener genitore1
        figlio2.iscrivi(evento1, genitore2);
        assertEquals(genitore2, evento1.getListeners().get(4)); // verifica listener genitore2
        // verifica numero listener genitori e totali
        ...
        // creazione evento2 per aggiornamento evento1
        ...
        // verifiche aggiornamento evento1 con evento2
    ...
    // Test per il metodo calcolaOraFine
    @Test
    void calcolaOraFine() {
        // Creazione di un evento di esempio
        Lettore creatore = new Lettore("Mario", "Rossi", "mariorossi");
        ...
        // Verifica che l'ora di fine sia calcolata correttamente
        assertEquals(18, oraFine.getHour());
        assertEquals(19, oraFine.getMinute());
    }

    // Test per il metodo setIscritti
    @Test
    void setIscritti() {
        // Creazione di un evento di esempio
        Lettore creatore = new Lettore("Mario", "Rossi", "mariorossi");
        ...
        // Verifica che il numero di iscritti sia stato impostato correttamente
