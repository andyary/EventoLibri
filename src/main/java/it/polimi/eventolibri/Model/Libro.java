...
public class Libro implements Serializable {
    ...
    public Libro(String titolo, int tempoLettura, String link, String autore, int id, ArrayList<Recensione> recensioni) {
        this(titolo, tempoLettura, link, autore, id); // chiamata al costruttore principale
        this.aggiungiRecensioni(recensioni); // aggiunta delle recensioni
    }
    ...
    public Libro(String titolo, int tempoLettura, String link, String autore, int id) {
        ...
        this.autore = autore;
        this.id = id;
        this.recensioni = new ArrayList<>(); // inizializzazione array vuoto
    }
    ...
    public Libro(String titolo, int tempoLettura, String link, String autore, int id, String isbn, ArrayList<Recensione> recensioni) {
        this(titolo, tempoLettura, link, autore, id, recensioni); // chiamata al costruttore principale
        this.isbn = isbn;  // impostazione dell'ISBN
    }
